		...
		function widget($args,$instance)
		{
			...
			<?php } else if($TotalSoftPortfolioOpt[0]->TotalSoftPortfolio_SetType == 'Elastic Grid'){ ?>
				<style type="text/css">
					...
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> { list-style: none; padding: 20px 0 !important; margin: 0 auto !important; text-align: center; width: 100%; }
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li { display: inline-block; margin: 10px 5px 0 5px !important; vertical-align: top; padding: 0 !important; position: static !important; }
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li.hidden { display: none; }
					.ogtot-grid<?php echo $Total_Soft_Portfolio;?> li > a, .ogtot-grid<?php echo $Total_Soft_Portfolio;?> li > a img { border: none; outline: none; display: block; position: relative; }
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li a:hover, .ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li a:focus { border-bottom: none !important; }
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li a { overflow: hidden; }
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li a.unhoverdir { overflow: visible; }
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li a figure { position: absolute; width: 100%; height: 100%; }
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li a figure span { display: block; padding: 10px 0; margin: 40px 20px 20px 20px; font-weight: normal; }
					...
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> .sep { display: none;}
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> .sep { margin: 20px 10px; height: 80%}
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li { height:<?php echo $TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_22;?>px; }
					...
					.ogtot-grid<?php echo $Total_Soft_Portfolio; ?> li a figure span
					{
						...
						<?php if ($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_27 == 'bold') {?>  
							font-weight: <?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_27;?>;
						<?php }else if($TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_27 == 'italic'){ ?>
							font-style: <?php echo $TotalSoftPortfolioOpt2[0]->TotalSoft_PG_2_27;?>;
						<?php } ?>
					}
					.no_overflow {
					  /*overflow: hidden;*/
					...
					.ogtot-expander<?php echo $Total_Soft_Portfolio; ?>
					{
						...
						/*overflow: overlay;*/
						/*padding-bottom: 5px;*/
						<?php if ($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_08>600) {?>
							max-height: <?php echo(($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_08)-100);?>px;
						<?php } else{?>
							max-height: <?php echo(($TotalSoftPortfolioOpt1[0]->TotalSoft_PG_1_08)+100);?>px;
						<?php } ?>
					...
					.ogtot-expander<?php echo $Total_Soft_Portfolio; ?>::-webkit-scrollbar {width: 9px;}
					/* Track */
					.ogtot-expander<?php echo $Total_Soft_Portfolio; ?>::-webkit-scrollbar-track {background: none;}
					/* Handle */
					...
					.ogtot-details<?php echo $Total_Soft_Portfolio; ?> p:nth-child(2) { max-height:200px !important; overflow-x:hidden !important; }
					.ogtot-details<?php echo $Total_Soft_Portfolio; ?> p:nth-child(2)::-webkit-scrollbar { width: 0.5em; }
					...
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-carousel ul li { min-width: 20px; margin: 0 5px !important; }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-wrapper { position: relative; margin: 0 auto; min-height: 60px; }
					...
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-horizontal nav { padding: 0 !important; }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-horizontal { padding: 10px 40px; }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-vertical { padding: 40px 10px; }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-carousel { overflow: hidden; position: relative; }
					...
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-horizontal ul { white-space: nowrap; }
					...
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-horizontal ul li { height: 100%; display: inline-block; width:100px !important; }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-vertical ul li { display: block; }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-carousel ul li a { display: inline-block; width: 100%; padding: 0px; }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-carousel ul li a img { display: block; max-width: 100%; }
					/* Navigation Arrows */
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-wrapper nav span { position: absolute; border-radius: 50%; cursor: pointer; opacity: 0.8; }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-wrapper nav span:hover { opacity: 1.0 }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-horizontal nav span { top: 50%; left: 10px; margin-top: -11px; }
					.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-horizontal nav span.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-next { right: 10px; left: auto; }
					...
					@media only screen and (max-width : 480px) { .elastislidetot<?php echo $Total_Soft_Portfolio; ?>-wrapper { max-width: 300px; } 
					}
					@media (max-width: 767px) 
					{
						.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-horizontal ul li { width:100px !important; }
						.elastislidetot<?php echo $Total_Soft_Portfolio; ?>-wrapper { max-width: 300px; padding-bottom: 5px; }
					}
					...
					setTimeout(function(){
							...
							jQuery('#portfolio-filter li').find('a').each(function(ind,el){
								...
								jQuery('.all').each(function(ind,el){
									if(jQuery('#ogtot-grid<?php echo $Total_Soft_Portfolio; ?>').hasClass('effect-fly')){
										console.log(el);
										jQuery(el).find('a').click(function(){jQuery(el).css({'opacity':'1'});console.log(777);});
									}
								});
