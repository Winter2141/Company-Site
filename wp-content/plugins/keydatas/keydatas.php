...
Description: 简数(keydatas.com)是一个通用、简单、智能、在线的网页数据采集和发布平台，功能强大，操作简单。支持定时采集+自动发布，定时发布，站群发布；集成强大的数据处理和SEO优化工具；支持微信公众号文章(包括采集公众号历史文章)、今日头条、淘宝客商品一键采集；集成翻译和同义词替换等服务；图片下载支持存储到阿里云OSS、七牛对象存储、腾讯云对象存储，并支持压缩和水印；免费自动接入多家IP代理商。同时支持LightSNS主题;即将推出知乎、简书采集。
Version: 2.3.19
Author: keydatas
